...
const Invoice = () => {
  ...
  return (<><div className="main" style={{ padding: "40px" }} ref={ref}>
    <style
    ...
    <div className="details">
      <div className="col">
        ...
        <img className="sign" src={sign} alt="Red dot" style={{ width: "250px", objectFit: "contain" }} />
    ...
    <hr />
    <div className="col-100">
      Reg Address: Shreyash Retail Private Limited,Second Floor, Plot No. 82,
      Okhla Industrial Estate, Phase - III, New Delhi, Delhi, 110020, , Delhi,
      Delhi-110020
      <br /> <br />
    ...
    <div className="wrapper" style={{display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"}}>
      <div className="download" style={{ padding: "10px", background: "green", color: 'white', borderRadius: "10px", cursor: "pointer" }} onClick={() => { generatePDF(ref, options) }}>
        Download
      </div>
    </div>
  </>
